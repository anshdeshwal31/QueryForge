"""
Django settings for QueryForge project.
"""
...
WSGI_APPLICATION = 'queryforge.wsgi.application'

# Database - Using SQLite for simplicity (can be changed)
DATABASES = {
    'default': {
